...
class _TaskDetailsScreenState extends State<TaskDetailsScreen> {
  final _textstyle = TextStyle(color: Constants.darkBlue, fontSize: 13, fontWeight: FontWeight.normal);
  final _titlesStyle = TextStyle(color: Constants.darkBlue, fontWeight: FontWeight.bold, fontSize: 20);
